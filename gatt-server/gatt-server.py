"""
Based on example for a BLE 4.0 Server using a GATT dictionary of services and characteristics
...
from bless import BlessServer, BlessGATTCharacteristic, GATTCharacteristicProperties, GATTAttributePermissions, BlessGATTRequest, BlessGATTSession #type: ignore
